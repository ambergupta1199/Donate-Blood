<?php 
	...
	if(isset($_POST['SignIn'])){
		...
		if(isset($email)&&isset($password)){
			...
			$adminsql="SELECT * FROM admin WHERE password='$password' AND email='$email'";
			...
			<strong>No Record Exist! Check Credentials </strong>
			<button type="button" class="close" data-dismiss="alert" aria-label="Close">
			  <span aria-hidden="true">&times;</span>
			</button>
		  </div> ';
...
<div class="conatiner size ">
	<div class="row">
		...
		?>
			...
			<button class="btn btn-danger btn-lg center-aligned" onclick="window.location.href='forgot-password.php';"  type="submit" name="ForgotPassword">Forgot Password?</button>
