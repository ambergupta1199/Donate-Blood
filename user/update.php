...
if(isset($_POST['submit'])){
  ...
  if(isset($name) && isset($blood_group)&&isset($gender)&&isset($city)&&isset($state)&&isset($contact)&&isset($day)&&isset($month)&&isset($year)&&isset($email)){
	  $DonorDOB=$day.'-'.$month.'-'.$year;
	  $sql="UPDATE donor SET name='$name',gender='$gender',email='$email',city='$city',dob='$DonorDOB',contact_no='$contact',blood_group='$blood_group',state='$state' WHERE id=".$_SESSION['user_id'];
	...
	if(isset($_POST['old_password'])&&!empty($_POST['old_password'])&& isset($_POST['c_password'])&&!empty($_POST['c_password']) && isset($_POST['new_password'])&&!empty($_POST['new_password'])){
	  ...
	  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
		<span aria-hidden="true">&times;</span>
			...
			$passwordError= ' <div class="alert alert-danger alert-dismissible fade show" role="alert">
	  <strong>Please Enter Correct Confirm Password</strong>
	  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
		<span aria-hidden="true">&times;</span>
	  </button>
	</div> ';
		...
		$passwordError= ' <div class="alert alert-danger alert-dismissible fade show" role="alert">
  <strong>Password should not be empty!</strong>
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
	<span aria-hidden="true">&times;</span>
  </button>
</div> ';
...
<style>
		...
		padding: 20px 10px 20px 30px;
			...
			<div class="row">
				...
				<div class=" card col-md-6 offset-md-3">
					...
					<?php if(isset($updatetError)) echo $updatetError;
			...
			<?php if(isset($yearError)) echo $yearError;?> 
				    ...
				    <div class="form-group">
						...
						<input type="text" name="email" id="email" placeholder="Email"  title="Please write correct email" class="form-control" value="<?php if(isset($email)) echo $email;?>" autocomplete="off">
					</div>
					<?php if(isset($emailError)) echo $emailError;?> 

					<div class="form-group">
              <label for="contact_no">Contact No</label>
              <input type="text" name="contact_no"  placeholder="Contact No." class="form-control" required pattern="^\d{10}$" title="10 numeric characters only" maxlength="10" value="<?php if(isset($contact)) echo $contact;?>">
            </div><!--End form-group-->
			...
			<select name="state" class="states order-alpha form-control demo-default" id="stateId"><?php if(isset($state)) echo '<option value="'.$state.'" selected>'.$state.'</option>';?></select>
              <label for="city">City</label>
              <select name="city" class="cities order-alpha form-control demo-default" id="cityId">
	<?php if(isset($city)) echo '<option value="'.$city.'">'.$city.'</option>';?>
</select>
            </div><!--city end-->
            ...
            <div class="form-group">
				...
				?>
					...
					<input type="password" required name="old_password" placeholder="Current Password" class="form-control" ></input>
					</div>
					
					<div class="form-group">
					<label for="newpassword">New Password</label>
					<input type="password" required name="new_password" placeholder="New Password" class="form-control" ></input>
					</div>

					<div class="form-group">
					<label for="c_password">Confirm Password</label>
					<input type="password" required name="c_password" placeholder="Confirm Password" class="form-control" ></input>
					</div>

					<div class="form-group">
						<button name="update_pass" type="submit" class="btn btn-lg btn-danger center-aligned" style="margin-top: 20px;">Update Password</button>
					</div>
					</form>
			</div>
		</div>
	...
	<div class=" card col-md-6 offset-md-3">
				...
				?>
					...
					<input type="password" required name="account_password" placeholder="Current Password" class="form-control" ></input>
					</div>
<div class="form-group">
<button name="delete_account" type="submit" class="btn btn-lg btn-danger center-aligned" style="margin-top: 20px;">Delete Account</button>
