    ...
    <ul class="navbar-nav form-inline my-2 my-lg-0">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
          ...
          <a class="dropdown-item" href="signin.php"><i class="fa fa-user" aria-hidden="true"></i>User</a>

          <a class="dropdown-item" href="signin.php"><i class="fa fa-user" aria-hidden="true"></i>
          Admin</a>
